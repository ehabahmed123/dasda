...
async def start_(client: Client, message: Message):
    await message.reply_photo(
        ...
        caption=f"""**المطور @libcubehawk .
 مرحبا بك انا بوت تشغيل الاغاني في المكالمات الصوتيه   ...
💞 الطريقة في الاسفل 
الحساب المساعد[𝗔𝘀𝘀𝗶𝘀𝘁𝗮𝗻𝘁 𝗥𝗶𝗻𝗼.♪](https://t.me/Assistant_rino) ...
**""",
    reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "طريقة التشغيل", url=f"https://t.me/djrino2"
                    ),
                    InlineKeyboardButton(
                        "المطور", url="https://t.me/libcubehawk"
                    )
                ],
                [
                    InlineKeyboardButton(
    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        " ʀᴇᴘᴏ ⚒️", url=f"https://replit.com/@dashezup/generate-pyrogram-session-string")
                ]
            ]
        ),
    )